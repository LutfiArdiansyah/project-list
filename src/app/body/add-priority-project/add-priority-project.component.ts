...
@Component({
  selector: 'app-add-priority-project',
  templateUrl: './add-priority-project.component.html',
  styleUrls: ['./add-priority-project.component.css']
})
export class AddPriorityProjectComponent implements OnInit {
  ...
  submit() {
    ...
    this.services.postData('add_priority_project',this.status_projects).subscribe(response => {
