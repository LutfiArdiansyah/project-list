...
export class AddProjectComponent implements OnInit {
  ...
  constructor(private services: ServiceService, private _location: Location, private router: Router) { }
  ...
  addProject() {
    ...
    this.setPicBa();
    this.setPicPmo();
    this.project.ticket = this.project.ticket.toString();
